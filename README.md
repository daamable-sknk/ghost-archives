...
→ [ghost.meta-archives.xyz](https://ghost.meta-archives.xyz) (예정)
...
| 소스 | 방법 |
|------|------|
| 뉴스 (한/영) | Google Alerts RSS |
| 학술 | Google Scholar Alerts |
| Bluesky | Bluesky API |
...
| 카테고리 | 설명 | 색상 |
|----------|------|------|
| 마케팅 아카이브 | 브랜드 헤리티지, 굿즈, 컬렉션 | 빨강 |
| 감성 아카이브 | 힙함, 구별짓기, 레트로 | 보라 |
| 큐레이션 아카이브 | 선별, 플레이리스트 | 노랑 |
| 시민 아카이브 | 대항 기억, 사회운동 | 초록 |
| 제도 아카이브 | 공공기록, 기관 | 회색 |
| 기술 아카이브 | 백업, 버전관리 | 검정 |
| 예술 아카이브 | 창작 재료, 형식 실험 | 파랑 |
